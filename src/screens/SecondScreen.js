...
const SecondScreen=()=>{
    const items = [
        {
            title: "תרגול",
            description: "תרגול תמיד עוזר! בכל לב שאת נמצאת בו - אבל בעיקר בהתחלה! כשאת עדיין לא שולטת ב100% מסוגי הידיים ומסוגי הטכניקות וככל שתתרגלי יותר- הדברים יבואו אלייך יותר בקלות",
            image: practice
        },
        {
            title: "התמדה",
    ...
    <div className={styles.description}>תחום הציפורניים הוא בין התחומים הכי מבוקשים היום! תעסוקה בו יכולה להכניס לך 5 ספרות בחודש, תוך כדי שאת מחליטה על עצמך וחיה את התחום שאת הכי אוהבת</div>
